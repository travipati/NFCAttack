...
public class SavedDB extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String sql = "CREATE TABLE replays(_id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT UNIQUE, transactions BLOB, type INTEGER, built_in INTEGER DEFAULT 0)";
        db.execSQL(sql);
        ...
        saveTransactions(db, "VivoPay 4000 - Visa", vivoPayVisa, 1, 1);
        saveTransactions(db, "VivoPay 4000 - MasterCard", vivoPayMasterCard, 1, 1);
        saveTransactions(db, "VivoPay 4000 - Discover", vivoPayDiscover, 1, 1);
        saveTransactions(db, "VivoPay 4000 - American Express", vivoPayAmex, 1, 1);
    }
